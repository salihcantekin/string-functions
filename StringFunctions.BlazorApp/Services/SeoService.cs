...
public class SeoService(IJSRuntime jsRuntime)
{
    private readonly string baseUrl = "https://stringfunctions.net";
    private readonly string siteName = "String Functions";
    private readonly string defaultImage = "/icon-512.png";

    public PageMetadata GetPageMetadata(string route)
    {
        var metadata = route.TrimStart('/').ToLowerInvariant() switch
        {
            "" or "index" => new PageMetadata
            {
                Title = "String Functions - Developer Tools for Text & JSON Operations",
                Description = "Free online string manipulation tools for developers. Base64 encode/decode, JSON formatter, regex tools, case converter, URL encoding, hash generator, and more.",
            ...
            "base64" => new PageMetadata
            {
                ...
                Description = "Fast and secure Base64 encoder and decoder. Convert text to Base64 or decode Base64 to text. Supports UTF-8, ASCII, Unicode encoding. Free online tool for developers.",
            ...
            "case-converter" => new PageMetadata
            {
                ...
                Description = "Free case converter tool. Convert text to camelCase, PascalCase, snake_case, kebab-case, UPPER CASE, and more. Perfect for developers and programmers.",
            ...
            "json-formatter" => new PageMetadata
            {
                ...
                Description = "Free JSON formatter and validator. Format, validate, minify, and beautify JSON data online. Syntax highlighting and error detection for developers.",
            ...
            {
                Title = "JSON to C# Class Generator - Convert JSON to C# Classes Online",
            ...
            {
                Title = "JSON to Java POJO Generator - Convert JSON to Java Classes",
                Description = "Generate Java POJO classes from JSON data. Free tool to convert JSON to Java objects with Gson, Jackson annotations support.",
            ...
            {
                Title = "JSON to TypeScript Interface Generator - Convert JSON to TS Types",
            ...
            {
                Title = "JSON Compare Tool - Compare and Diff JSON Files Online",
            ...
            {
                Title = "Hash Generator - MD5, SHA1, SHA256, SHA512 Hash Online",
            ...
            {
                Title = "Regex Replace Tool - Find and Replace with Regular Expressions",
            ...
            {
                Title = "Text Extract Tool - Extract Patterns from Text with Regex",
            ...
            {
                Title = "String Reverse Tool - Reverse Text and Lines Online",
            ...
            {
                Title = "Trim & Pad Tool - Remove Whitespace or Add Padding Online",
            ...
            {
                Title = "Line Counter - Count Lines, Words, and Characters Online",
            ...
            {
                Title = "Line Operations - Sort, Filter, and Dedupe Text Lines (Notepad++ Style)",
            ...
            {
                Title = "DateTime Formatter - Test C# DateTime Format Strings Online",
            ...
            {
                Title = "String Formatter - Test C# String Format and Interpolation",
            ...
            {
                Title = "GUID Generator - Generate UUID/GUID Online in Multiple Formats",
            ...
            {
                Title = "HTTP Client Tool - Test HTTP Requests Online (GET, POST, PUT, DELETE)",
            ...
            {
                Title = "Number Converter - Convert Binary, Decimal, Hex, Octal Online",
